...
public class BindingABSActivity extends BindingActivityV30
    ...
    protected View createBindableActionBar() {
	    if (VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB){
	    	return super.createBindableActionBar();
	    }
	    return new BindableActionBar(this, this.getSherlock());
    }
	
	@Override
    protected View createBindableOptionsMenu() {
	    return new BindableOptionsMenu(this, this.getSherlock());
    }
